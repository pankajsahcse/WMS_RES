...
public class CEController extends BaseController{
	...
	public static final Logger logger = LoggerFactory.getLogger(CEController.class);
	...
	public ModelAndView viewHome(HttpServletRequest request, Model model) {
		...
		ModelAndView modelAndView = new ModelAndView("ce/ceHome");
	...
	public ModelAndView viewDashboard(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView("ce/dashboard");
		return modelAndView;
...
//		UserJson userJson = userService.getAllUsers(pageable, searchBoxVal, designation, status);
	...
	public ModelAndView viewCeReports(HttpServletRequest request) {
		user = RESUtil.getUserDetail();
		logger.info("User - " + user.getUsername() + ", Role - " + user.getAuthorities() + " - Displaying Chief Offices Report of Work");
		ModelAndView modelAndView = new ModelAndView(
				"ce/viewChiefWorkReport");
		return modelAndView;
	}*/
	...
	public String fetchChiefOfficeWorkReport(HttpServletRequest request) {
		...
		user = RESUtil.getUserDetail();
		logger.info("User - " + user.getUsername() + ", Role - " + user.getAuthorities() + " - Fetching Chief Office Work Report");
...
//		UserJson userJson = userService.getAllUsers(pageable, searchBoxVal, designation, status);
		...
		ExecutiveWorkJson workJson = ceService.getAllChiefWorks(pageable);
		Gson gson = new GsonBuilder().setPrettyPrinting().create();
		String json = gson.toJson(workJson);
		return json;
	}*/
	...
	public ModelAndView viewUserForm(
		...
		user = RESUtil.getUserDetail();
		logger.info("User - " + user.getUsername() + ", Role - " + user.getAuthorities() + " - Displaying Edit Legacy Form");
		ModelAndView modelAndView = new ModelAndView("ce/viewLegacyDataForm");
		return modelAndView;
	}*/
	@RequestMapping(value = "/reviseLegacyDataMapping/{id}", method = RequestMethod.GET)
	public ModelAndView reviseEditUserForm(
			@PathVariable String id, HttpServletRequest request) {

		user = RESUtil.getUserDetail();
		logger.info("User - " + user.getUsername() + ", Role - " + user.getAuthorities() + " - Displaying Edit Legacy Form");
		ModelAndView modelAndView = new ModelAndView("ce/reviseLegacyDataForm");
		return modelAndView;
	}
	@RequestMapping(value = "/historyLegacyDataMapping/{id}", method = RequestMethod.GET)
	public ModelAndView historyEditUserForm(
			@PathVariable String id, HttpServletRequest request) {

		user = RESUtil.getUserDetail();
		logger.info("User - " + user.getUsername() + ", Role - " + user.getAuthorities() + " - Displaying Edit Legacy Form");
		ModelAndView modelAndView = new ModelAndView("ce/historyLegacyDataForm");
		return modelAndView;
	}
	@RequestMapping(value = "/viewHLegacyData/{workLoggingId}", method = RequestMethod.GET)
	public ModelAndView viewHLegacyData(@PathVariable Long workLoggingId,
			HttpServletRequest request) {
		...
		modelAndView = new ModelAndView("ce/viewHLegacyData");
