...
public class AEController extends BaseController{
	...
	public static final Logger logger = LoggerFactory.getLogger(AEController.class);
	...
	public ModelAndView viewHome(HttpServletRequest request, Model model) {
		...
		ModelAndView modelAndView = new ModelAndView("ae/aeHome");
	...
	public ModelAndView viewDashboard(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView("ae/dashboard");
		return modelAndView;
