...
@RestController
@RequestMapping("/enc/*")
public class ENCController extends BaseController{
	
	public static final Logger logger = LoggerFactory.getLogger(ENCController.class);
	...
	public ModelAndView viewHome(HttpServletRequest request, Model model) {
		...
		ModelAndView modelAndView = new ModelAndView("enc/encHome");
	...
	public ModelAndView viewDashboard(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView("enc/dashboard");
		return modelAndView;
