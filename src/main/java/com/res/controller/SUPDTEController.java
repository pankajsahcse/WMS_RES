...
import com.res.service.SupDteService;
import com.res.service.UserService;
import com.res.util.RESUtil;

@RestController
@RequestMapping("/supdte/*")
public class SUPDTEController extends BaseController{
	
	public static final Logger logger = LoggerFactory.getLogger(SUPDTEController.class);
	...
	@Autowired
	private SupDteService supdteService;
	...
	public ModelAndView viewHome(HttpServletRequest request, Model model) {
		...
		ModelAndView modelAndView = new ModelAndView("supdte/supdteHome");
	...
	public ModelAndView viewDashboard(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView("supdte/dashboard");
		return modelAndView;
	...
	public String fetchWorkList(HttpServletRequest request) {
...
//		UserJson userJson = userService.getAllUsers(pageable, searchBoxVal, designation, status);
		...
		WorkJson workJson = eeService.getAllWorks(pageable);
	...
	public ModelAndView viewSupdteReports(HttpServletRequest request) {
		user = RESUtil.getUserDetail();
		logger.info("User - " + user.getUsername() + ", Role - " + user.getAuthorities() + " - Displaying Superintending Offices Report of Work");
		ModelAndView modelAndView = new ModelAndView(
				"supdte/viewSupdteWorkReport");
		return modelAndView;
	}*/
	@RequestMapping(value = "/editLegacyDataMapping/{id}", method = RequestMethod.GET)
	public ModelAndView viewEditUserForm(
		...
		user = RESUtil.getUserDetail();
		logger.info("User - " + user.getUsername() + ", Role - " + user.getAuthorities() + " - Displaying Edit Legacy Form");
		ModelAndView modelAndView = new ModelAndView("ce/editLegacyDataForm");
		return modelAndView;
	}
	
	@RequestMapping(value = "/manageSqmUsersForSe", method = RequestMethod.GET)
	public ModelAndView manageSqmUsersForSe(HttpServletRequest request) {

		user = RESUtil.getUserDetail();
		logger.info("User - " + user.getUsername() + ", Role - " + user.getAuthorities()
				+ " - Displaying Manage SQM Users page");
		ModelAndView modelAndView = new ModelAndView("supdte/manageSqmUsersForSe");
		return modelAndView;
	}
	
	@RequestMapping(value = "/fetchSqmUserListForSe", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	public String fetchSqmUserList(HttpServletRequest request) {
		...
		UserJson userJson = userService.getAllSqmUsersForSe(pageable, searchBoxVal, designation, status, officeId);
		...
		@RequestMapping(value = "/editSqmUserFormForSe/{id}", method = RequestMethod.GET)
		public ModelAndView editSqmUserFormForSe(@PathVariable String id, HttpServletRequest request) {

			user = RESUtil.getUserDetail();
			logger.info(
					"User - " + user.getUsername() + ", Role - " + user.getAuthorities() + " - Displaying Edit User Form");
			ModelAndView modelAndView = new ModelAndView("supdte/editSqmUserFormForSe");
			return modelAndView;
		}
