...
@Entity
@Table(name = "MST_WORK_ESTIMATION_STATUS")
public class WorkEstimationStatus implements Serializable {
    ...
    public WorkEstimationStatus() {
    }
    
	public WorkEstimationStatus(Long workRequestStatusId) {
