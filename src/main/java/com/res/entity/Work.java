...
public class Work extends Auditable implements Serializable {
	...
	@JoinColumn(name = "WORK_NATURE_ID", referencedColumnName = "WORK_NATURE_ID")
	@ManyToOne
	// @Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
	private WorkNature workNatureId;
	
	@JoinColumn(name = "scheme_type_id", referencedColumnName = "id")
	@ManyToOne
	// @Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
	private SchemeSanctionedUnderProgramme schemeTypeId;
	...
	private Short legacyRevise;
	
	@Column(name = "competent_auth_name")
	private String competentAuthName;
	
	@Column(name = "competent_auth_desig")
	private String competentAuthDesig;
	
	@Column(name = "is_estimation_revised")
	private Short isEstimationRevised;
	
	@Column(name="max_billing_amount")
	private BigDecimal maxBillingAmount;
	
	@Column(name = "final_exp_amount_date")
	@Temporal(TemporalType.TIMESTAMP)
	private Date finalExpAmountDate;
	
	@Column(name = "allow_sub_eng_to_prepare_bill")
	private Short allowSubEngToPrepareBill;
	
	@Column(name = "revised_ts_amt")
	private BigDecimal revisedTsAmt;
	
	@Column(name = "revised_as_amt")
	...
	public Short getLegacyRevise() {
		return legacyRevise;
	}

	public void setLegacyRevise(Short legacyRevise) {
		this.legacyRevise = legacyRevise;
	}
	...
	List<WorkTender> workTender;
	
	
	@JoinColumn(name = "kml_file_id", referencedColumnName = "id")
	@OneToOne
	private DocumentUpload kmlFileUpload;
	...
	public Date getFinalExpAmountDate() {
		return finalExpAmountDate;
	}

	public void setFinalExpAmountDate(Date finalExpAmountDate) {
	...
	public List<WorkTender> getWorkTender() {
		return workTender;
	}

	public void setWorkTender(List<WorkTender> workTender) {
		this.workTender = workTender;
	}

	public WorkNature getWorkNatureId() {
		return workNatureId;
	}

	public void setWorkNatureId(WorkNature workNatureId) {
		this.workNatureId = workNatureId;
	}

	public DocumentUpload getKmlFileUpload() {
		return kmlFileUpload;
	}

	public void setKmlFileUpload(DocumentUpload kmlFileUpload) {
		this.kmlFileUpload = kmlFileUpload;
	}

	
	public SchemeSanctionedUnderProgramme getSchemeTypeId() {
		return schemeTypeId;
	}

	public void setSchemeTypeId(SchemeSanctionedUnderProgramme schemeTypeId) {
