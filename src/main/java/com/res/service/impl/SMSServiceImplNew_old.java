 ...
 */
@Service
public class SMSServiceImplNew_old {
	...
	public String sendSingleUnicodeSMS(SMSBean smsBean){
		...
		try {
			...
			String genratedhashKey = hashGenerator(userName, senderId, smsBean.getSmsText(), secureKey);
			...
			nameValuePairs.add(new BasicNameValuePair("content", smsBean.getSmsText()));
